...
# Unit tests for IpfsPinningSdk::PinStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe IpfsPinningSdk::PinStatus do
  let(:instance) { IpfsPinningSdk::PinStatus.new }

  describe 'test an instance of PinStatus' do
    it 'should create an instance of PinStatus' do
      expect(instance).to be_instance_of(IpfsPinningSdk::PinStatus)
    end
  end
