...
IpfsPinningSdk - the Ruby gem for the IPFS Pinning Service API
...
```shell
gem build ipfspinning_sdk.gemspec
```

Then either install the gem locally:

```shell
gem install ./ipfspinning_sdk-1.0.0.gem
```

(for development, run `gem install --dev ./ipfspinning_sdk-1.0.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ipfspinning_sdk', '~> 1.0.0'

### Install from Git

If the Ruby gem is hosted at a git repository: https://github.com/GIT_USER_ID/GIT_REPO_ID, then add the following in the Gemfile:

    gem 'ipfspinning_sdk', :git => 'https://github.com/GIT_USER_ID/GIT_REPO_ID.git'
...
------------ | ------------- | ------------- | -------------
*IpfsPinningSdk::PinsApi* | [**pins_get**](docs/PinsApi.md#pins_get) | **GET** /pins | List pin objects
*IpfsPinningSdk::PinsApi* | [**pins_post**](docs/PinsApi.md#pins_post) | **POST** /pins | Add pin object
*IpfsPinningSdk::PinsApi* | [**pins_requestid_delete**](docs/PinsApi.md#pins_requestid_delete) | **DELETE** /pins/{requestid} | Remove pin object
*IpfsPinningSdk::PinsApi* | [**pins_requestid_get**](docs/PinsApi.md#pins_requestid_get) | **GET** /pins/{requestid} | Get pin object
*IpfsPinningSdk::PinsApi* | [**pins_requestid_post**](docs/PinsApi.md#pins_requestid_post) | **POST** /pins/{requestid} | Replace pin object


## Documentation for Models

 - [IpfsPinningSdk::Failure](docs/Failure.md)
 - [IpfsPinningSdk::FailureError](docs/FailureError.md)
 - [IpfsPinningSdk::Pin](docs/Pin.md)
 - [IpfsPinningSdk::PinResults](docs/PinResults.md)
 - [IpfsPinningSdk::PinStatus](docs/PinStatus.md)
 - [IpfsPinningSdk::Status](docs/Status.md)
 - [IpfsPinningSdk::TextMatchingStrategy](docs/TextMatchingStrategy.md)
