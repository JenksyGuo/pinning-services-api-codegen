...
from IpfsPinningSDK.exceptions import ApiAttributeError
...
class Status(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Status a pin object can have at a pinning service., must be one of ["queued", "pinning", "pinned", "failed", ]  # noqa: E501

        Keyword Args:
            value (str): Status a pin object can have at a pinning service., must be one of ["queued", "pinning", "pinned", "failed", ]  # noqa: E501
