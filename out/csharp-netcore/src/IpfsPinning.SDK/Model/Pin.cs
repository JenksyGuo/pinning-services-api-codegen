...
using OpenAPIDateConverter = IpfsPinning.SDK.Client.OpenAPIDateConverter;

namespace IpfsPinning.SDK.Model
{
    /// <summary>
    /// Pin object
    /// </summary>
    ...
    public partial class Pin : IEquatable<Pin>, IValidatableObject
    {
        ...
        public Pin(string cid = default(string), string name = default(string), List<string> origins = default(List<string>), Dictionary<string, string> meta = default(Dictionary<string, string>))
        {
            // to ensure "cid" is required (not null)
            this.Cid = cid ?? throw new ArgumentNullException("cid is a required property for Pin and cannot be null");
            this.Name = name;
