...
namespace IpfsPinning.SDK.Model
{
    ...
    public partial class PinStatus : IEquatable<PinStatus>, IValidatableObject
    {
        ...
        public PinStatus(string requestid = default(string), Status status = default(Status), DateTime created = default(DateTime), Pin pin = default(Pin), List<string> delegates = default(List<string>), Dictionary<string, string> info = default(Dictionary<string, string>))
        {
