...
namespace IpfsPinning.SDK.Test.Api
{
    /// <summary>
    ...
    public class PinsApiTests : IDisposable
    {
        ...
        public void PinsGetTest()
        {
            ...
            //var response = instance.PinsGet(cid, name, match, status, before, after, limit, meta);
        ...
        /// </summary>
        [Fact]
        public void PinsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Pin pin = null;
            //var response = instance.PinsPost(pin);
            //Assert.IsType<PinStatus>(response);
        }

        /// <summary>
        /// Test PinsRequestidDelete
        /// </summary>
        [Fact]
        public void PinsRequestidDeleteTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string requestid = null;
            //instance.PinsRequestidDelete(requestid);
        }

        /// <summary>
        /// Test PinsRequestidGet
        /// </summary>
        [Fact]
        public void PinsRequestidGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string requestid = null;
            //var response = instance.PinsRequestidGet(requestid);
            //Assert.IsType<PinStatus>(response);
        }

        /// <summary>
        /// Test PinsRequestidPost
        /// </summary>
        [Fact]
        public void PinsRequestidPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string requestid = null;
            //Pin pin = null;
            //var response = instance.PinsRequestidPost(requestid, pin);
            //Assert.IsType<PinStatus>(response);
        }
    }
}
